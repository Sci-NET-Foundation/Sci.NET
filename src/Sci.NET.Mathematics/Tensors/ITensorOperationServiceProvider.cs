...
#pragma warning disable CA1024
    ...
    /// <summary>
    /// Gets an instance of the <see cref="IHypotService"/>.
    /// </summary>
    /// <returns>An instance of the <see cref="IHypotService"/>.</returns>
    public IHypotService GetHypotService();

    /// <summary>
    /// Gets an instance of the <see cref="INormService"/>.
    /// </summary>
    /// <returns>An instance of the <see cref="INormService"/>.</returns>
