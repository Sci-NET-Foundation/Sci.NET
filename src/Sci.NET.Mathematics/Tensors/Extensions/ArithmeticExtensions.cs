...
public static class ArithmeticExtensions
{
    ...
    /// <summary>
    /// Finds the square root of the <paramref name="scalar"/> <see cref="Scalar{TNumber}"/>.
    /// </summary>
    /// <param name="scalar">The <see cref="Scalar{TNumber}"/> to find the square root of.</param>
    /// <typeparam name="TNumber">The number type of the <paramref name="scalar"/> and result.</typeparam>
    /// <returns>The square root of the <paramref name="scalar"/>.</returns>
    [DebuggerStepThrough]
    ...
    /// <summary>
    /// Finds the square root of the <paramref name="vector"/> <see cref="Vector{TNumber}"/>.
    /// </summary>
    /// <param name="vector">The <see cref="Vector{TNumber}"/> to find the square root of.</param>
    /// <typeparam name="TNumber">The number type of the <paramref name="vector"/> and result.</typeparam>
    /// <returns>The square root of the <paramref name="vector"/>.</returns>
    [DebuggerStepThrough]
    ...
    /// <summary>
    /// Finds the square root of the <paramref name="matrix"/> <see cref="Matrix{TNumber}"/>.
    /// </summary>
    /// <param name="matrix">The <see cref="Matrix{TNumber}"/> to find the square root of.</param>
    /// <typeparam name="TNumber">The number type of the <paramref name="matrix"/> and result.</typeparam>
    /// <returns>The square root of the <paramref name="matrix"/>.</returns>
    [DebuggerStepThrough]
    ...
    /// <summary>
    /// Finds the square root of the <paramref name="tensor"/> <see cref="Tensor{TNumber}"/>.
    /// </summary>
    /// <param name="tensor">The <see cref="Tensor{TNumber}"/> to find the square root of.</param>
    /// <typeparam name="TNumber">The number type of the <paramref name="tensor"/> and result.</typeparam>
    /// <returns>The square root of the <paramref name="tensor"/>.</returns>
    [DebuggerStepThrough]
