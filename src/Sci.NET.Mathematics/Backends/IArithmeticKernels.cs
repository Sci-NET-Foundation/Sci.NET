...
public interface IArithmeticKernels
{
    ...
    /// <summary>
    /// Negates the elements of a <see cref="ITensor{TNumber}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Takes the absolute value of the elements of a <see cref="ITensor{TNumber}"/>.
    /// </summary>
    /// <param name="tensor">The <see cref="ITensor{TNumber}"/> to take the absolute value of.</param>
    ...
    /// <summary>
    /// Calculates the gradient of the absolute value of a <see cref="ITensor{TNumber}"/>.
    /// </summary>
    /// <param name="tensor">The <see cref="ITensor{TNumber}"/> to take the absolute value of.</param>
    ...
    public void AbsGradient<TNumber>(
        ITensor<TNumber> tensor,
        ITensor<TNumber> gradient,
        ITensor<TNumber> result)
        where TNumber : unmanaged, INumber<TNumber>;

    /// <summary>
    /// Finds the absolute difference between two <see cref="ITensor{TNumber}"/>s.
    /// </summary>
    /// <param name="left">The left <see cref="ITensor{TNumber}"/> to subtract from.</param>
    /// <param name="right">The right <see cref="ITensor{TNumber}"/> to subtract.</param>
    ...
    /// <summary>
    /// Takes the square root of the elements of a <see cref="ITensor{TNumber}"/>.
    /// </summary>
    /// <param name="tensor">The <see cref="ITensor{TNumber}"/> to take the square root of.</param>
