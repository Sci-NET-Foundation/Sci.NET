...
internal class ACosMicroKernel<TNumber> : IUnaryOperation<TNumber>, IUnaryOperationAvx2
    where TNumber : unmanaged, INumber<TNumber>, IFloatingPointIeee754<TNumber>, ITrigonometricFunctions<TNumber>
{
    ...
    {
        return input < -TNumber.One || input > TNumber.One ? TNumber.NaN : TNumber.Acos(input);
    }
