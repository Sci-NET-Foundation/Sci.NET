...
internal class AcotBackwardsMicroKernel<TNumber> : IBinaryOperation<TNumber>, IBinaryOperationAvx2
    where TNumber : unmanaged, INumber<TNumber>
{
    ...
    public static Vector256<float> ApplyAvxFp32(Vector256<float> left, Vector256<float> right)
    {
        ...
        var denominator = Avx.Add(Vector256.Create(1.0f), x2);
    ...
    {
        var x2 = Avx.Multiply(left, left);
        var denominator = Avx.Add(Vector256.Create(1.0d), x2);
