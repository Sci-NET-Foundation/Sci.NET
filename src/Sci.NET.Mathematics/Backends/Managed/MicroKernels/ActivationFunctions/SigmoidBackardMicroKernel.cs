...
internal class SigmoidBackardMicroKernel<TNumber> : IUnaryOperation<TNumber>, IUnaryOperationAvx2
    where TNumber : unmanaged, INumber<TNumber>, IExponentialFunctions<TNumber>
{
    ...
    {
        var sigmoid = TNumber.One / (TNumber.One + TNumber.Exp(-input));
        return sigmoid * (TNumber.One - sigmoid);
    }
    ...
    {
        var sigmoid = 1d / (1d + Math.Exp(-input));
