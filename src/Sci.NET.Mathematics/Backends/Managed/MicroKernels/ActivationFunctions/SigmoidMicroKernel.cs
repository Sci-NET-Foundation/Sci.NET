...
internal class SigmoidMicroKernel<TNumber> : IUnaryOperation<TNumber>, IUnaryOperationAvx, IUnaryOperationAvxFma
    where TNumber : unmanaged, INumber<TNumber>, IExponentialFunctions<TNumber>
{
    ...
    {
        return TNumber.One / (TNumber.One + TNumber.Exp(-input));
    }
