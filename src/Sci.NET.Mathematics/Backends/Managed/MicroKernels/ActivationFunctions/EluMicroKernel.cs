...
internal class EluMicroKernel<TNumber> : IUnaryOperationWithScalar<TNumber>, IUnaryOperationWithScalarAvx, IUnaryOperationWithScalarAvxFma
    where TNumber : unmanaged, INumber<TNumber>, IExponentialFunctions<TNumber>
{
    ...
    {
        return input > TNumber.Zero ? input : scalar * (TNumber.Exp(input) - TNumber.One);
    }
