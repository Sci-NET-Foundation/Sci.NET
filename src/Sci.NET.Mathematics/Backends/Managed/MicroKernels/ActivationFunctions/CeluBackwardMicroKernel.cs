...
internal class CeluBackwardMicroKernel<TNumber> : IUnaryOperationWithScalar<TNumber>, IUnaryOperationWithScalarAvx, IUnaryOperationWithScalarAvxFma
    where TNumber : unmanaged, INumber<TNumber>, IExponentialFunctions<TNumber>
{
    ...
    {
        return TNumber.Min(TNumber.One, scalar * TNumber.Exp(input / scalar));
    }
