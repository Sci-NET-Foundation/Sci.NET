...
internal class FusedUnaryOperation<TFirstOp, TSecondOp, TThirdOp, TNumber> : IUnaryOperation<TNumber>, IUnaryOperationAvx2
    ...
    where TNumber : unmanaged, INumber<TNumber>
{
    ...
    {
        return TFirstOp.HasAvx2Implementation() && TSecondOp.HasAvx2Implementation() && TThirdOp.HasAvx2Implementation();
    }
    ...
    public static TNumber ApplyScalar(TNumber input)
    {
        ...
        return TThirdOp.ApplyScalar(intermediate);
    }
    ...
    public static float ApplyScalarFp32(float input)
    {
        ...
        return TThirdOp.ApplyScalarFp32(intermediate);
    }
    ...
    public static double ApplyScalarFp64(double input)
    {
        ...
        return TThirdOp.ApplyScalarFp64(intermediate);
    }
    ...
    public static Vector256<float> ApplyAvx2Fp32(Vector256<float> input)
    {
        ...
        return TThirdOp.ApplyAvx2Fp32(intermediate);
    }
    ...
    public static Vector256<double> ApplyAvx2Fp64(Vector256<double> input)
    {
        ...
        return TThirdOp.ApplyAvx2Fp64(intermediate);
    }
}