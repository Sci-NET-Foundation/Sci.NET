...
internal class LogBackwardMicroKernel<TNumber> : IUnaryOperation<TNumber>, IUnaryOperationAvx, IUnaryOperationAvxFma
    where TNumber : unmanaged, INumber<TNumber>, IFloatingPointIeee754<TNumber>
{
    ...
    {
        return Avx.Divide(Vector256<float>.One, input);
    }

    [MethodImpl(ImplementationOptions.HotPath)]
    public static Vector256<double> ApplyAvxFp64(Vector256<double> input)
    {
        return Avx.Divide(Vector256<double>.One, input);
    }
