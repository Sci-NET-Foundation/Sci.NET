...
/// <summary>
/// Interface for AVX FMA unary operations.
/// </summary>
public interface IUnaryOperationAvxFma : IUnaryOperationAvxTail
{
    /// <summary>
    ...
    public static abstract Vector256<float> ApplyAvxFmaFp32(Vector256<float> input);
    ...
    /// <returns>The result of the operation.</returns>
    public static abstract Vector256<double> ApplyAvxFmaFp64(Vector256<double> input);
}