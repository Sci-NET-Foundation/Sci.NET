...
internal class PointwiseLessThanOrEqualMicroKernel<TNumber> : IBinaryOperation<TNumber>, IBinaryOperationAvx, IBinaryOperationAvxFma
    where TNumber : unmanaged, INumber<TNumber>
{
    ...
    {
        var lessThanOrEqualMask = Avx.CompareLessThanOrEqual(left, right);
