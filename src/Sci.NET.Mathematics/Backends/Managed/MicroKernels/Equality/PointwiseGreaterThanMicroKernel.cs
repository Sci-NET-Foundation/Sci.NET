...
internal class PointwiseGreaterThanMicroKernel<TNumber> : IBinaryOperation<TNumber>, IBinaryOperationAvx, IBinaryOperationAvxFma
    where TNumber : unmanaged, INumber<TNumber>
{
    ...
    {
        var greaterThanMask = Avx.CompareGreaterThan(left, right);
        return Avx.BlendVariable(Vector256<float>.Zero, Vector256<float>.One, greaterThanMask);
    }
    ...
    {
        var greaterThanMask = Avx.CompareGreaterThan(left, right);
        return Avx.BlendVariable(Vector256<double>.Zero, Vector256<double>.One, greaterThanMask);
    }
