...
internal static class ManagedStreamingUnaryOperationWithScalarIterator
{
        ...
        where TOp : IUnaryOperationWithScalarAvxFma
    {
        ...
        for (; i <= count - NativeBufferHelpers.AvxVectorSizeFp32; i += NativeBufferHelpers.AvxVectorSizeFp32)
        {
            ...
            var result = TOp.ApplyAvxFmaFp32(inputVector, scalarVector);
        ...
        for (; i < count; i++)
        {
            ...
            resultPtr[start + i] = TOp.ApplyTailFp32(input, scalar);
        }
    }
        ...
        where TOp : IUnaryOperationWithScalarAvxFma
    {
        ...
        for (; i <= count - NativeBufferHelpers.AvxVectorSizeFp64; i += NativeBufferHelpers.AvxVectorSizeFp64)
        {
            ...
            var inputVector = Avx.LoadVector256(inputPtr + start + i);
            var result = TOp.ApplyAvxFmaFp64(inputVector, scalarVector);
        ...
        for (; i < count; i++)
        {
            ...
            resultPtr[start + i] = TOp.ApplyTailFp64(inputValue, scalar);
        }
    }
        ...
        where TOp : IUnaryOperationWithScalarAvx
    {
        ...
        for (; i <= count - NativeBufferHelpers.AvxVectorSizeFp32; i += NativeBufferHelpers.AvxVectorSizeFp32)
        {
            ...
            var inputVector = Avx.LoadVector256(inputPtr + start + i);
            var result = TOp.ApplyAvxFp32(inputVector, scalarVector);
        ...
        {
            var inputValue = inputPtr[start + i];
            resultPtr[start + i] = TOp.ApplyTailFp32(inputValue, scalar);
        }
    }
        ...
        where TOp : IUnaryOperationWithScalarAvx
    {
        ...
        for (; i <= count - NativeBufferHelpers.AvxVectorSizeFp64; i += NativeBufferHelpers.AvxVectorSizeFp64)
        {
            ...
            var inputVector = Avx.LoadVector256(inputPtr + start + i);
            var result = TOp.ApplyAvxFp64(inputVector, scalarVector);
        ...
        where TNumber : unmanaged, INumber<TNumber>
    {
        ...
        {
            var inputValue = inputPtr[start + i];
            resultPtr[start + i] = TOp.ApplyScalar(inputValue, scalar);
        }
    }
}